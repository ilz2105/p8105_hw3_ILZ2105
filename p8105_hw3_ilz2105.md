...
| Activity app | ears to b | e higher o | n some Mondays and most weekends compared to Tuesday-Friday. There does not appear to be any distinct |
| trends in th | e data ju | st from lo |                           oking at the values for `day_activity` and comparing them to the `day`. The |
| weekdays see |  m pretty | consistent |                   in value for the most part, staying between 300,000 to 500,000 with some days going |
| lower or hig | her. It i | s difficul |                                                                  t to tell without looking at a plot. |
...
![](p8105_hw3_ilz2105_files/figure-gfm/plot-1.png)<!-- --> Describe in
